export const vynapse = {
  ...
  description: [
    "Building hybrid ML runtime combining neuroevolution with gradient-based training in safe Rust",
  ...
  technicalDetails: [
    ...
    "TensorFlow-inspired graph execution engine to unify evolution with gradient-based training",
    "Dynamic architecture evolution combined with backpropagation (Milestone 1 of 10)",
  ],
};
